...
export const oauthApi = {
  initiateOAuth: (provider: 'google' | 'microsoft'): Promise<ApiResponse<OAuthInitResponse>> =>
...
export const calendarApi = {
  getUserCalendars: (params?: PaginationParams): Promise<PaginatedResponse<Calendar>> =>
    api.get('/calendars', { params }).then(res => res.data),

  getCalendarEvents: (data: CalendarEventsParams): Promise<PaginatedResponse<Event>> => {
    const { calendarIds, ...params } = data;
    return api.post('/calendars/events', { calendarIds }, { params }).then(res => res.data);
  },
  ...
  syncCalendarEvents: (calendarId: string, params?: DateRangeParams): Promise<ApiResponse<Event[]>> =>
    api.post(`/calendars/sync/calendar/${calendarId}/events`, {}, { params }).then(res => res.data),
...
export const boardApi = {
  createBoard: (data: CreateBoardRequest): Promise<ApiResponse<CalendarBoard>> =>
  ...
  updateBoard: (boardId: string, data: UpdateBoardRequest): Promise<ApiResponse<CalendarBoard>> =>
  ...
  addCalendarToBoard: (boardId: string, data: AddCalendarToBoardRequest): Promise<ApiResponse<any>> =>
    api.post(`/boards/${boardId}/calendars`, data).then(res => res.data),

  removeCalendarFromBoard: (boardId: string, calendarId: string): Promise<ApiResponse<void>> =>
    api.delete(`/boards/${boardId}/calendars/${calendarId}`).then(res => res.data),

  updateCalendarColor: (boardId: string, calendarId: string, data: UpdateCalendarColorRequest): Promise<ApiResponse<any>> =>
    api.patch(`/boards/${boardId}/calendars/${calendarId}`, data).then(res => res.data),

  getBoardEvents: (boardId: string, params?: DateRangeParams): Promise<ApiResponse<BoardEventsResponse>> =>
...
export const shareApi = {
  ...
  updateSharedLink: (boardId: string, data: UpdateSharedLinkRequest): Promise<ApiResponse<SharedLink>> =>
  ...
  getSharedBoard: (token: string, params?: DateRangeParams): Promise<ApiResponse<BoardEventsResponse>> =>
